...
<body>
    ...
    <div class="container">
        <form action="luce-gas-a..php" method="POST" class="login-email" id="formInserimento">
            <div class="container">
            ...
            <div class="container">
                <div class="container">
                    <label for="index_pun_radio">Listino LUCE   <br>applicato?</label>
                    <div>
                        <p>Index
            ...
            <div class="container">
                <div class="container">
                    <label for="index_pun_radio">Listino GAS   <br>applicato</label>
                    <div>
                        <p>Index
