...
if (isset($_POST['submit'])) {
	...
	$sql = "INSERT INTO contratti (r_sociale, iban, email, tel, stipula, insert_date, stato, FK_id_users, via_for, cap_for, comune_for, citta_for, luce, valore, business, data_inserimento, index_or_pun, effic, consAnnuo, gettone)
        VALUES ('$rSociale_uc', '$iban', '$email', '$cellulare', '$stipula', '$insertDateDB2', '$stato', '$agente', '$viaFor', '$capFor', '$comuneFor', '$cittaFor_uc', '$x', '$punti', '$business', '$data_inserimento', '$index_or_pun', '$effic', '$consAnnuo', '$gettone')";
