...
if (isset($_POST['submit'])) {
	...
	$insertDateDB2 = $d->format('H:i:s | \ d-m-Y');
        ...
        $sql = "INSERT INTO contratti (r_sociale, iban, email, tel, stipula, insert_date, stato, FK_id_users, via_for, cap_for, comune_for, citta_for, luce_gas, valore, business)
