    ...
    <div class="container">
        <form action="FIX-tipo-privato-domestico1.1.php" method="POST" class="login-email" id="formInserimento">
            ...
            <div class="container">
                ...
                <!--                 <div class="container-effic">
                    <div class="input-group">
                        <input list="lista-stati-valori" id="effic" name="effic" />
                        <datalist id="lista-stati-valori">
                            <option value="1">Efficentamento SI
                            <option value="0">Efficentamento NO
                        </datalist>
                    </div>
                </div> -->
                <!-- 
                <div class="container-effic">
                    <div class="">
                        <input type=”radio” id="effic" name”affirmative” value=”1” checked>
                        Yes
                        </input>

                        <input type=”radio” id="effic" name”negative” value=”0”>
                        No
                        </input>
                    </div>
                </div> -->
            ...
            <div class="container">
                <div class="container">
                    <div class="input-group">
                        <input class="input-group" type="number" name="consAnnuoUP" placeholder="Consumo Annuo">Inserisci il consumo annuo.
                    </div>
                </div>


                    <div class="container">
                    <label for="yes_no_radio">Il Cliente ha stipulato anche efficentamento?</label>
