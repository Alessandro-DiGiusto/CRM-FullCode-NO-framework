...
<!-- <img src="img/man-technologist-medium-light-skin-tone.png" class="logo" style="width: 85px;"> -->
    ...
    <div class="container">
        <form action="luce-d..php" method="POST" class="login-email" id="formInserimento">
            <div class="container">
            ...
            <div class="container">
                <div class="input-group"><p>Stipula</p>
    ...
    <div class="footer">
        <center>
            <img src="img/man-technologist-medium-light-skin-tone.png">
