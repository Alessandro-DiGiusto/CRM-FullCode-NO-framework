...
<body>
    ...
    <div class="container">
        <form action="luce-gas-d..php" method="POST" class="login-email" id="formInserimento">
            <div class="container">
            ...
            <div class="container">
                <div class="container">
                    <label for="index_pun_radio">Listino applicato   <br>Luce?</label>
                    <div class="input-groupl">
                        <p>Index
            ...
            <div class="container">
                <div class="container">
                    <label for="index_pun_radio_gas">Listino applicato   <br>Gas?</label>
                    <div class="input-groupl">
                        <p>Index
                            <input type="radio" name="index-pun-gas" value="0" checked></input>
                        </p>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="input-group">
                        <p>Gas</p>
                        <input class="input-group" type="number" name="consAnnuoUP-gas" placeholder="Consumo Annuo">
                    </div>
                </div>
            </div>
