...
$selectDal = $_POST['selectDal'];
$selectAl = $_POST['selectAl'];
var_dump($selectDal);
$select = "SELECT * FROM contratti
INNER JOIN users
ON contratti.FK_id_users = users.id
/* AND contratti.data_inserimento BETWEEN '$electric_date_F' AND '$electric_date_L'
...
<body>
    ...
    <div class="container">
        ...
        <form action="form_ricerca.php" method="POST" class="login-email" id="formInserimento">
            <div class="container_statoUP-header">
                <p class="login-text" style="font-size: 2rem; font-weight: 800;">Ordina view Contratti</p>
                <div class="input-group">
                    <center>Dal
                        <input type="date" placeholder="DAL" name="selectDal" value="<?php echo $_POST['selectDal']; ?>">
                </div>
                <div class="input-group">
                    <center>Al
                        <input type="date" placeholder="AL" name="selectAl" value="<?php echo $_POST['selectAl']; ?>">
                </div>
                <div class="input-group">
                    <center>
                            ...
                            if ($row['stato'] == "2") {
                                ...
                                if ($row['stato'] == "3") {
                                    ...
                                    if ($row['stato'] == "4") {
                                        ...
                                        if ($row['stato'] == "5") {
                                            echo "<div id=td-color_approved>" . "APPROVATO" . "</div>";
                                        }
                                    }
                                }
                            }
